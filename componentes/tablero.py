...
board[0][0] = ('Rook1', dark_rook_image)
board[0][7] = ('Rook1', dark_rook_image)
board[0][1] = ('Knight1', dark_knight_image)
board[0][6] = ('Knight1', dark_knight_image)
board[0][2] = ('Bisharp1', dark_bisharp_image)
board[0][5] = ('Bisharp1', dark_bisharp_image)
board[0][3] = ('Queen1', dark_queen_image)
board[0][4] = ('King1', dark_king_image)
for i in range(8):
    board[1][i] = ('Paw1', dark_paw_image) 

board[7][0] = ('Rook2', light_rook_image)
board[7][7] = ('Rook2', light_rook_image)
board[7][1] = ('Knight2', light_knight_image)
board[7][6] = ('Knight2', light_knight_image)
board[7][2] = ('Bisharp2', light_bisharp_image)
board[7][5] = ('Bisharp2', light_bisharp_image)
board[7][3] = ('Queen2', light_queen_image)
board[7][4] = ('King2', light_king_image)
for i in range(8):
    board[6][i] = ('Paw2', light_paw_image) 
